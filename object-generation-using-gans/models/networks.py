...
class SPP_NET(nn.Module):
    ...
    def spatial_pyramid_pool(self, previous_conv, num_sample, previous_conv_size, out_pool_size):
        ...
        for i in range(len(out_pool_size)):
            ...
            h_pad = int(
                (h_wid * out_pool_size[i] - previous_conv_size[0] + 1) / 2)
            w_pad = int(math.floor(
                (w_wid * out_pool_size[i] - previous_conv_size[1] + 1) / 2))

            # print("####################### model.optimize_parameters(only_d)
            # ###########################")
