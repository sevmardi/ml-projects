...
class Pix2PixModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.netD_person = networks.define_person_D(
        ...
        if not self.isTrain or opt.continue_train:
            ...
            if self.isTrain:
                ...
                self.load_network(self.netD_person,
                                  'D_person', opt.which_epoch)
        ...
        if self.isTrain:
            ...
            self.criterionGAN_person = networks.GANLoss(
                use_lsgan=opt.no_lsgan, tensor=self.Tensor)
    ...
    def backward_D_image(self):
        ...
        # Combined loss
        self.loss_D_image = (self.loss_D_image_fake +
                             self.loss_D_image_real) * 0.5

        self.loss_D_image.backward()

    def backward_D_person(self):
        # Fake
        # print("####################### netD_person.forward()
        # ###########################")
        ...
        self.loss_D_person_fake = self.criterionGAN_person(
            self.person_fake, False)
        ...
        self.loss_D_person_real = self.criterionGAN_person(
            self.person_real, True)

        # Combine loss
        self.loss_D_person = (self.loss_D_person_fake +
                              self.loss_D_person_real) * 0.5
    ...
    def backward_G(self):
        ...
        self.loss_G_GAN_person = self.criterionGAN_person(
            pred_fake_person, True)
